...
/*WIFI configuration*/
#define ESP_WIFI_SSID      "WifiArduino"
#define ESP_WIFI_PASS      "12345hjj"
#define ESP_MAXIMUM_RETRY  10

/*Telegram configuration*/
#define TOKEN "5823651133:AAGYlrJUF3mJ8Zk_pchIb95d6X5xxrFQcKk"
...
static void https_telegram_sendMessage_perform_post(void) {
	...
	*/
    ...
    if (potable == 1) {
        sprintf(post_data,"{\"chat_id\":%s,\"text\":\"Temperatura: %0.1f, ph: %0.2f, orp: %0.2f mV. ES POTABLE\n\"}",chat_ID2, tempmedia/7, phmedia/7, orpmedia/7);
    } else {
        sprintf(post_data,"{\"chat_id\":%s,\"text\":\"Temperatura: %0.1f, ph: %0.2f, orp: %0.2f mV. NO ES POTABLE\n\"}",chat_ID2, tempmedia/7, phmedia/7, orpmedia/7);
    }
